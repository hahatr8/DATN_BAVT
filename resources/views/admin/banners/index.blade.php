                        ...
                        <tbody>
                            @foreach ($data as $Banners)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.banners.show', $Banners) }}"
                                            class="btn btn-sm btn-info">Xem chi
                                            tiết</a>
                                        <a href="{{ route('admin.banners.edit', $Banners) }}"
                                            class="btn btn-sm btn-warning mt-2 mb-2">Chỉnh sửa</a>
                                        <a href="{{ route('admin.banner.softDestruction', $Banners) }}"
                                            onclick="return confirm('Bạn có chắc chắn muốn xóa {{ $Banners->title }} không?')"
