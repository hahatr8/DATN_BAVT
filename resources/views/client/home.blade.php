                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="product-caption text-center">
                                            <div class="product-identity">
                                                <p class="manufacturer-name"><a href="">{{ $product->brand->name }}</a></p>
                                            </div>
                                ...
                                <div class="group-slide-item">
                                    <div class="group-item">
                                        ...
                                        <div class="group-item-desc">
                                            <h5 class="group-product-name"><a href="{{ route('client.product_detail', $product->id) }}">
                                                    {{ $product->name }}</a></h5>
                                            <div class="price-box">
                                                <span class="price-regular">{{ number_format($product->price, 0, ',', '.') }}
                                                    VND</span>
                        ...
                        <div class="blog-post-item">
                            <figure class="blog-thumb">
                                <a href="{{ route('client.blogDetail', $blog)}}">
                                    <img src="{{ \Storage::url($blog->img) }}" alt="blog image">
                                </a>
                            </figure>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="product-details-des ms-5">
                                ...
                                <div class="price-box">
                                    <span class="price-regular" id="product-price" data-base-price="0" data-size-price="0"></span>
                                </div>
                                <p class="pro-desc" id="product-description"></p>
                                <div>
                                    <h6 class="option-title">Size :</h6>
                                    <div class="quantity-cart-box d-flex align-items-center" id="size-quantity-container" style="display: none;">
                                        <!-- Chúng ta sẽ tạo select này thông qua JavaScript -->
                                    </div>
                                </div>
                                <div>
                                    <h6 class="option-title">Số lượng :</h6>
                                    <div class="quantity-cart-box d-flex align-items-center" id="quantity-container" style="display: none;">
                                        <div class="quantity">
