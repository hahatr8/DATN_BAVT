                        ...
                        <div class="mb-3">
                            ...
                            <select name="product[brand]" class="form-select">
                                ...
                                @foreach ($brands as $id => $name)
                                    <option value="{{ $id }}"
                                        {{ old('product.brand') == $id ? 'selected' : '' }}>{{ $name }}</option>
                                @endforeach
                            </select>
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                            ...
                            <tbody id="image-table-body">
                                <tr id="row_0">
                                    <td class="d-flex align-items-center">
                                        ...
                                        <input type="file" id="img_0" name="array_img[0]" class="form-control"
                        ...
                        <div>
                            @if ($errors->has('array_img'))
                                <small class="text-danger">{{ $errors->first('array_img') }}</small>
                            @endif
                        </div>
                ...
                <div class="card-body">
                            ...
                            <tr id="size_row_0">
                                <td>
                                    <input type="text" class="form-control" name="product_sizes[0][variant]"
                                        placeholder="Nhập tên size" value="{{ old('product_sizes.0.variant') }}">
                                ...
                                <td>
                                    <input type="number" class="form-control" name="product_sizes[0][price]"
                                        placeholder="Nhập giá" value="{{ old('product_sizes.0.price') }}">
                                ...
                                <td>
                                    <input type="number" class="form-control" name="product_sizes[0][quantity]"
                                        placeholder="Nhập số lượng" value="{{ old('product_sizes.0.quantity') }}">
                                    @if ($errors->has('product_sizes.0.quantity'))
                                        <small
                                            class="text-danger">{{ $errors->first('product_sizes.0.quantity') }}</small>
                                    @endif
                                </td>
                                <td>
                                    <select class="form-control" name="product_sizes[0][status]">
                                        <option value="1"
                                            {{ old('product_sizes.0.status') == '1' ? 'selected' : '' }}>Hoạt động</option>
                                        <option value="0"
                                            {{ old('product_sizes.0.status') == '0' ? 'selected' : '' }}>Không hoạt động</option>
                                    </select>
                    ...
                    <div>
                        @if ($errors->has('product_sizes'))
                            <small class="text-danger">{{ $errors->first('product_sizes') }}</small>
                        @endif
                    </div>
