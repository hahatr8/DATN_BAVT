                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <!-- Các trường form khác như tên, mô tả, hình ảnh sản phẩm, v.v. --> 
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="danh_muc_id" class="form-select @error('danh_muc_id') is-invalid @enderror">
                                                ...
                                                @foreach ($categories as $id => $name)
                                                    <option value="{{ $id }}" {{ old('danh_muc_id') == $id ? 'selected' : '' }}>
                                                        {{ $name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" id="so_luot_xem" name="so_luot_xem"
                                                class="form-control 
                                            @error('so_luot_xem') is-invalid @enderror"
                                                value="{{ old('so_luot_xem') }}" placeholder="Lượt Xem">
                                            @error('so_luot_xem')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label for="hang_san_pham" class="form-label">Hãng Sản Phẩm</label>
                                            <input type="number" id="hang_san_pham" name="hang_san_pham"
                                                class="form-control 
                                            @error('hang_san_pham') is-invalid @enderror"
                                                value="{{ old('hang_san_pham') }}" placeholder="Hãng Sản Phẩm">
                                            @error('hang_san_pham')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-8">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="content" id="noi_dung_content" class="d-none"></textarea>
                                        </div>
                                        <div class="mb-3">
