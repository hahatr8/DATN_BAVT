                                                ...
                                                <figure class="product-thumb">
                                                    ...
                                                    <div class="cart-hover">
                                                        <button class="btn btn-cart" data-bs-toggle="modal"
                                                            ...
                                                            data-sizes="{{ $product->productSizes->where('status', 1)->map(
                                                                    fn($size) => [
                                                                        'id' => $size->id,
                                ...
                                <div class="banner-slide-item">
                                    <figure class="banner-statistics">
                                        <a href="{{ route('brand.products', ['id' => $brand->id]) }}">
                                            <div>
                                                <img src="{{ asset('storage/' . $brand->logo) }}" alt="brand"
                        ...
                        <div class="categories-group-wrapper">
                            ...
                            <div class="group-list-item-wrapper">
                                <div class="group-list-carousel">
                                    ...
                                    @foreach ($productCheaps as $product)
                                        <!-- group list item start -->
                                        <div class="group-slide-item">
                                            <div class="group-item">
                                                <div class="group-item-thumb">
            ...
            document.querySelectorAll('.btn-cart').forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    document.getElementById('product-price').textContent = productPrice
                        .toLocaleString('en-US') // Sử dụng định dạng mặc định
                        .replace(/,/g, '.') + ' VND'; // Thay dấu phẩy bằng dấu chấm
                ...
                fetch(cartUrl, {
                    ...
                    .then(async (response) => {
                        ...
                        if (response.ok) {
                            ...
                            // Nếu lỗi do validate từ backend
                            if (data.errors) {
                    ...
                    .catch((error) => {
                        ...
                        Swal.fire({
                            title: 'Lỗi!',
                            text: error.message || 'Đã xảy ra sự cố, vui lòng thử lại.',
                            icon: 'error',
                            timer: 5000,
