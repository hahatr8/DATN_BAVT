...
<header class="header-area header-wide">
    ...
    @php
        // dd(Auth::user());
    @endphp
    {{-- <a href="{{ route('client.orders.index') }}" class="btn btn-outline-primary d-flex align-items-center justify-content-center" style="gap: 10px; padding: 10px 20px; text-decoration: none;">
        <i class="pe-7s-box2" style="font-size: 1.5rem;"></i> <!-- Icon -->
        <span style="font-size: 1rem; font-weight: 600;">Xem đơn hàng</span>
    </a> --}}
